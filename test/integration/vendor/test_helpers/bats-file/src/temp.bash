...
temp_make() {
  ...
  # START(retr0h): https://github.com/ztombol/bats-file/pull/4/files#diff-107c5cbe040da0dcd199f157970821ec
  ...
  # END(retr0h): https://github.com/ztombol/bats-file/pull/4/files#diff-107c5cbe040da0dcd199f157970821ec
